...
import CalendarObjView from '@/components/eventDetailsContainer/calendar-obj-view';
import { eventViewStyles } from '@/components/eventDetailsContainer/eventDetailsStyles';
import { EventTimeDatePicker } from '@/components/eventDetailsContainer/expanded-view-time';
import PlaceSearchBar from '@/components/eventDetailsContainer/location-container';
import { MutateButtons } from '@/components/eventDetailsContainer/mutate-buttons';
...
export const MockEventDetails = ({ initialEvent, onClose, newEvent }: ExpandedViewProps) => {
